...
const Login = () => {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 place-items-center h-screen overflow-hidden">
            <div className="max-[sm]:hidden">
                <Lottie className="max-w-[400px]" animationData={groovyWalkAnimation} loop={true} />
            </div>
                ...
                <Card className="w-96">
                    ...
                    <div className="text-center flex gap-2 justify-center">
                        ...
                        <div className="flex gap-x-3">
                            <button onClick={handleGoogleLogin}> Google <i class="fa fa-google" aria-hidden="true"></i></button>
                        </div>
                    </div>
